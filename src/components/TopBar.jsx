...
export function TopBar({ filters, setFilter, onMenuClick }) {
  ...
  // Keep the input in sync when the search filter is reset from elsewhere
  // (e.g. "Clear all filters"), so the box doesn't keep showing stale text
  // once it no longer reflects the active filter. Adjusted during render
